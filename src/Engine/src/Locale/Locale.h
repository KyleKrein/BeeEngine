...
namespace BeeEngine::Locale
{
    ...
    public:
        ...
        Localization(const Localization& other) : m_Locale(other.m_Locale), m_Language(other.m_Language) {}
         ...
         */
        std::string_view GetLanguage() const { return {m_Locale.begin(), m_Locale.begin() + 2}; }
        /**
         * Retrieves the language string.
         *
         * @return The language string.
         */
        const String& GetLanguageString() const { return m_Language; }
        /**
         ...
         */
        std::string_view GetCountry() const { return {m_Locale.begin() + 3, m_Locale.end()}; }
        /**
        ...
        constexpr auto operator<=>(const Localization& other) const noexcept { return m_Locale <=> other.m_Locale; }
        constexpr auto operator<=>(const UTF8String& other) const noexcept { return m_Locale <=> other; }
        constexpr bool operator==(const Localization& other) const noexcept { return m_Locale == other.m_Locale; }
        /**
         ...
         */
        String ToString() const { return m_Locale; }
...
namespace std
{
    ...
    {
        std::size_t operator()(const BeeEngine::Locale::Localization& key) const { return key.Hash(); }
    };
} // namespace std
namespace BeeEngine::Locale
{
    ...
    public:
         ...
         *
         * @param key The key to be translated.
         * @param args The arguments to be used for formatting the translated string. The arguments must be key-value
         * pairs.
         * @return The translated string.
         */
        UTF8String Translate(const char* key, Args&&... args) const
        {
            static_assert(sizeof...(args) % 2 == 0,
                          "Translate() requires an even number of arguments for key-value pairs.");
    ...
    private:
        ...
        {
            // static_assert(sizeof...(args) % 2 == 0, "Translate() requires an even number of arguments for key-value
            // pairs."); AreKeysStrings<Args...>(std::index_sequence_for<Args...>{});
        ...
        {
            static_assert(((Indices % 2 != 0 ||
                            std::is_convertible_v<std::tuple_element_t<Indices, std::tuple<Args...>>, String>) &&
                           ...),
