...
namespace BeeEngine
{
    ...
    public:
        ...
        [[nodiscard]] inline static float GetMouseX() { return s_MouseX; }
        [[nodiscard]] inline static float GetMouseY() { return s_MouseY; }
        [[nodiscard]] inline static float GetMouseWheelX() { return s_MouseWheelX; }
        [[nodiscard]] inline static float GetMouseWheelY() { return s_MouseWheelY; }
