...
namespace BeeEngine::Reflection
{
    ...
    template <class T>
    concept HasReflection = requires { T::Reflection; };
    ...
    struct TypeDescriptor_Struct : TypeDescriptor
    {
        struct Member
        {
            ...
            void* GetPtr(void* objectPtr) const { return static_cast<char*>(objectPtr) + Offset; }
        ...
        TypeDescriptor_Struct(const char* name,
                              size_t size,
...
#define REFLECT_STRUCT_MEMBER(name)                                                                                    \
    ::BeeEngine::Reflection::TypeDescriptor_Struct::Member{                                                            \
        #name, offsetof(T, name), &::BeeEngine::Reflection::TypeResolver::Get<decltype(T::name)>()},
/*
