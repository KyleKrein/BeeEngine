...
namespace BeeEngine
{
    ...
    public:
        ...
        [[nodiscard]] Texture2D& LoadTexture(const String& name, uint32_t width, uint32_t height, gsl::span<byte> data);
        ...
        [[nodiscard]] Font& LoadFont(const String& name, gsl::span<byte> data);
