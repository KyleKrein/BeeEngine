...
namespace BeeEngine
{
    enum ManagedBindingFlags : int32_t
    {
        ...
        ManagedBindingFlags_Public =
            16, // 0x00000010
                /// <summary>Specifies that non-public members are to be included in the search.</summary>
        ManagedBindingFlags_NonPublic =
            32, // 0x00000020
                /// <summary>Specifies that public and protected static members up the hierarchy should be returned.
                /// Private static members in inherited classes are not returned. Static members include fields,
                /// methods, events, and properties. Nested types are not returned.</summary>
        ManagedBindingFlags_FlattenHierarchy =
            64, // 0x00000040
                /// <summary>Specifies that a method is to be invoked. This must not be a constructor or a type
                /// initializer.
                ///
                /// This flag is passed to an <see langword="InvokeMember" /> method to invoke a method.</summary>
        ManagedBindingFlags_InvokeMethod =
            256, // 0x00000100
                 /// <summary>Specifies that reflection should create an instance of the specified type. Calls the
                 /// constructor that matches the given arguments. The supplied member name is ignored. If the type of
                 /// lookup is not specified, (Instance | Public) will apply. It is not possible to call a type
                 /// initializer.
                 ///
                 /// This flag is passed to an <see langword="InvokeMember" /> method to invoke a constructor.</summary>
        ManagedBindingFlags_CreateInstance =
            512, // 0x00000200
        ...
        ManagedBindingFlags_SetField =
            2048, // 0x00000800
                  /// <summary>Specifies that the value of the specified property should be returned.
                  ///
                  /// This flag is passed to an <see langword="InvokeMember" /> method to invoke a property
                  /// getter.</summary>
        ManagedBindingFlags_GetProperty =
            4096, // 0x00001000
                  /// <summary>Specifies that the value of the specified property should be set. For COM properties,
                  /// specifying this binding flag is equivalent to specifying <see langword="PutDispProperty" /> and
                  /// <see langword="PutRefDispProperty" />.
                  ///
                  /// This flag is passed to an <see langword="InvokeMember" /> method to invoke a property
                  /// setter.</summary>
        ManagedBindingFlags_SetProperty =
            8192, // 0x00002000
                  /// <summary>Specifies that the <see langword="PROPPUT" /> member on a COM object should be invoked.
                  /// <see langword="PROPPUT" /> specifies a property-setting function that uses a value. Use <see
                  /// langword="PutDispProperty" /> if a property has both <see langword="PROPPUT" /> and <see
                  /// langword="PROPPUTREF" /> and you need to distinguish which one is called.</summary>
        ManagedBindingFlags_PutDispProperty =
            16384, // 0x00004000
                   /// <summary>Specifies that the <see langword="PROPPUTREF" /> member on a COM object should be
                   /// invoked. <see langword="PROPPUTREF" /> specifies a property-setting function that uses a
                   /// reference instead of a value. Use <see langword="PutRefDispProperty" /> if a property has both
                   /// <see langword="PROPPUT" /> and <see langword="PROPPUTREF" /> and you need to distinguish which
                   /// one is called.</summary>
        ManagedBindingFlags_PutRefDispProperty =
            32768, // 0x00008000
                   /// <summary>Specifies that types of the supplied arguments must exactly match the types of the
                   /// corresponding formal parameters. Reflection throws an exception if the caller supplies a non-null
                   /// <see langword="Binder" /> object, since that implies that the caller is supplying <see
                   /// langword="BindToXXX" /> implementations that will pick the appropriate method. The default binder
                   /// ignores this flag, while custom binders can implement the semantics of this flag.</summary>
        ManagedBindingFlags_ExactBinding = 65536, // 0x00010000
                                                  /// <summary>Not implemented.</summary>
        ManagedBindingFlags_SuppressChangeType =
            131072, // 0x00020000
                    /// <summary>Returns the set of members whose parameter count matches the number of supplied
                    /// arguments. This binding flag is used for methods with parameters that have default values and
                    /// methods with variable arguments (varargs). This flag should only be used with <see
    ...
    enum MFieldFlags : int32_t
    {
        ...
        MFieldFlags_Assembly =
            MFieldFlags_FamANDAssem | MFieldFlags_Private, // 0x00000003
                                                           /// <summary>Specifies that the field is accessible only by
                                                           /// type and subtypes.</summary>
        MFieldFlags_Family = 4,
        /// <summary>Specifies that the field is accessible by subtypes anywhere, as well as throughout this
        /// assembly.</summary>
        MFieldFlags_FamORAssem =
            MFieldFlags_Family | MFieldFlags_Private, // 0x00000005
                                                      /// <summary>Specifies that the field is accessible by any member
                                                      /// for whom this scope is visible.</summary>
        MFieldFlags_Public =
        ...
        MFieldFlags_InitOnly =
            32, // 0x00000020
                /// <summary>Specifies that the field's value is a compile-time (static or early bound) constant. Any
                /// attempt to set it throws a <see cref="T:System.FieldAccessException" />.</summary>
        MFieldFlags_Literal =
            64, // 0x00000040
        ...
        MFieldFlags_ReservedMask = MFieldFlags_HasFieldRVA | MFieldFlags_HasDefault | MFieldFlags_HasFieldMarshal |
                                   MFieldFlags_RTSpecialName, // 0x00009500
    };
