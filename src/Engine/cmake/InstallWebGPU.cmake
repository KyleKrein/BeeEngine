...
function(enable_webgpu target)
    ...
    target_include_directories( ${target} PUBLIC ${webgpu_dawn_SOURCE_DIR}/include)
    target_include_directories( ${target} PUBLIC ${CMAKE_BINARY_DIR}/_deps/webgpu_dawn-build/gen/include)
    target_link_libraries( ${target} PUBLIC webgpu_dawn)
endfunction()