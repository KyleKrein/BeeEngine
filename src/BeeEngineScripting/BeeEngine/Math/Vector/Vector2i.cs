...
namespace BeeEngine.Math
{
    ...
    public struct Vector2i : IEquatable<Vector2i>
    {
        ...
        /// </summary>
        public int ManhattanLength => MathU.Abs(X) + MathU.Abs(Y);

        /// <summary>
        /// Gets the euclidian length of the vector.
        /// </summary>
        public float EuclideanLength => (float)MathU.Sqrt((X * X) + (Y * Y));
        ...
        /// </summary>
        public static readonly unsafe int SizeInBytes = sizeof(Vector2i);
        ...
        {
            a.X = MathU.Min(a.X, b.X);
            a.Y = MathU.Min(a.Y, b.Y);
            return a;
        }
        ...
        {
            a.X = MathU.Max(a.X, b.X);
            a.Y = MathU.Max(a.Y, b.Y);
            return a;
        }
        ...
        {
            return String.Format("({0}{2} {1})", X, Y, MathU.ListSeparator);
        }
