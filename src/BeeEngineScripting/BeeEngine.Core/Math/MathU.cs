...
namespace BeeEngine.Math
{
    ...
    public static class MathU
    {
        ...
        [Pure]
        public static decimal Abs(decimal n) => System.Math.Abs(n);
        ...
        [Pure]
        public static short Abs(short n) => System.Math.Abs(n);
        ...
        [Pure]
        public static int Abs(int n) => System.Math.Abs(n);
        ...
        [Pure]
        public static long Abs(long n) => System.Math.Abs(n);
        ...
        [Pure]
        public static sbyte Abs(sbyte n) => System.Math.Abs(n);
        ...
        [Pure]
        public static double Sinh(double radians) => System.Math.Sinh(radians);
        ...
        [Pure]
        public static double Asin(double radians) => System.Math.Asin(radians);
        ...
        [Pure]
        public static double Cosh(double radians) => System.Math.Cosh(radians);
        ...
        /// <returns>Arc sine of the specified angle. If radians is equal to NaN, NegativeInfinity, or PositiveInfinity, this method returns NaN.</returns>
        [Pure]
        public static double Acos(double radians) => System.Math.Acos(radians);
        ...
        [Pure]
        public static double Tan(double radians) => System.Math.Tan(radians);
        ...
        [Pure]
        public static double Tanh(double radians) => System.Math.Tanh(radians);
        ...
        [Pure]
        public static double Atan(double radians) => System.Math.Atan(radians);
        ...
        [Pure]
        public static long BigMul(int a, int b) => System.Math.BigMul(a, b);
        ...
        [Pure]
        public static double Sqrt(double n) => System.Math.Sqrt(n);
        ...
        [Pure]
        public static decimal Ceiling(decimal n) => System.Math.Ceiling(n);
        ...
        [Pure]
        public static decimal Floor(decimal n) => System.Math.Floor(n);
        ...
        [Pure]
        public static int DivRem(int a, int b, out int result) => System.Math.DivRem(a, b, out result);
        ...
        /// <exception cref="DivideByZeroException">b is zero.</exception>
        [Pure]
        public static long DivRem(long a, long b, out long result) => System.Math.DivRem(a, b, out result);
        ...
        [Pure]
        public static double Log(double n) => System.Math.Log(n);
        ...
        [Pure]
        public static double Log(double n, double newBase) => System.Math.Log(n, newBase);
        ...
        [Pure]
        public static double Log2(double n) => System.Math.Log(n, 2);
        ...
        [Pure]
        public static double Exp(double n) => System.Math.Exp(n);
        ...
        [Pure]
        public static decimal Round(decimal d, int digits, MidpointRounding mode) => System.Math.Round(d, digits, mode);
        ...
        /// <exception cref="ArgumentException">mode is not a valid value of MidpointRounding.</exception>
        [Pure]
        public static double Round(double d, int digits, MidpointRounding mode) => System.Math.Round(d, digits, mode);
        ...
        /// <exception cref="OverflowException">The result is outside the range of a Decimal.</exception>
        [Pure]
        public static decimal Round(decimal d, MidpointRounding mode) => System.Math.Round(d, mode);
        ...
        /// <exception cref="ArgumentException">mode is not a valid value of MidpointRounding.</exception>
        [Pure]
        public static double Round(double d, MidpointRounding mode) => System.Math.Round(d, mode);
        ...
        /// <exception cref="OverflowException">The result is outside the range of a Decimal.</exception>
        [Pure]
        public static decimal Round(decimal d, int digits) => System.Math.Round(d, digits);
        ...
        /// <exception cref="ArgumentOutOfRangeException"> digits is less than 0 or greater than 15.</exception>
        [Pure]
        public static double Round(double d, int digits) => System.Math.Round(d, digits);
        ...
        /// Note that this method returns a Double instead of an integral type.</returns>
        [Pure]
        public static double Round(double d) => System.Math.Round(d);
        ...
        [Pure]
        public static int Sign(sbyte d) => System.Math.Sign(d);
        ...
        /// <returns>If d ≤ -1 returns -1, if 1 ≤ d returns 1 and if d = 0 returns 0.</returns>
        [Pure]
        public static int Sign(short d) => System.Math.Sign(d);
        ...
        /// <returns>If d ≤ -1 returns -1, if 1 ≤ d returns 1 and if d = 0 returns 0.</returns>
        [Pure]
        public static int Sign(decimal d) => System.Math.Sign(d);
        ...
        /// <returns>If d ≤ -1 returns -1, if 1 ≤ d returns 1 and if d = 0 returns 0.</returns>
        [Pure]
        public static int Sign(double d) => System.Math.Sign(d);
        ...
        /// <returns>If d ≤ -1 returns -1, if 1 ≤ d returns 1 and if d = 0 returns 0.</returns>
        [Pure]
        public static int Sign(long d) => System.Math.Sign(d);
        ...
        {
            const float radToDeg = (float)(180.0f / System.Math.PI);
        ...
        public static bool ApproximatelyEqual(float a, float b, int maxDeltaBits)
        {
            ...
            long k = BitConverter.DoubleToInt64Bits(a);
            if (k < 0)
            {
                k = int.MinValue - k;
            }

            long l = BitConverter.DoubleToInt64Bits(b);
            if (l < 0)
            {
                l = int.MinValue - l;
            }
