...
namespace BeeEngine.Math
{
    ...
    public struct Vector3i : IEquatable<Vector3i>
    {
        ...
        /// </summary>
        public int ManhattanLength => MathU.Abs(X) + MathU.Abs(Y) + MathU.Abs(Z);

        /// <summary>
        /// Gets the euclidian length of the vector.
        /// </summary>
        public float EuclideanLength => (float)MathU.Sqrt((X * X) + (Y * Y) + (Z * Z));
        ...
        /// </summary>
        public static readonly unsafe int SizeInBytes = sizeof(Vector3i);
        ...
        {
            Vector3i result;
            result.X = MathU.Min(a.X, b.X);
            result.Y = MathU.Min(a.Y, b.Y);
            result.Z = MathU.Min(a.Z, b.Z);
            return result;
        }
        ...
        {
            Vector3i result;
            result.X = MathU.Max(a.X, b.X);
            result.Y = MathU.Max(a.Y, b.Y);
            result.Z = MathU.Max(a.Z, b.Z);
            return result;
        }
        ...
        {
            return String.Format("({0}{3} {1}{3} {2})", X, Y, Z, MathU.ListSeparator);
        }
