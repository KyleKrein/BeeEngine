...
namespace BeeEngine.Math
{
    ...
    public struct Vector4i : IEquatable<Vector4i>
    {
        ...
        /// </summary>
        public int ManhattanLength => System.Math.Abs(X) + System.Math.Abs(Y) + System.Math.Abs(Z) + System.Math.Abs(W);

        /// <summary>
        /// Gets the euclidian length of the vector.
        /// </summary>
        public float EuclideanLength => (float)System.Math.Sqrt((X * X) + (Y * Y) + (Z * Z) + (W * W));
        ...
        /// </summary>
        public static readonly unsafe int SizeInBytes = sizeof(Vector4i);
        ...
        public static Vector4i ComponentMin(Vector4i a, Vector4i b)
        {
            ...
            result.Z = System.Math.Min(a.Z, b.Z);
            result.W = System.Math.Min(a.W, b.W);
            return result;
        }
        ...
        public static Vector4i ComponentMax(Vector4i a, Vector4i b)
        {
            ...
            result.Z = System.Math.Max(a.Z, b.Z);
            result.W = System.Math.Max(a.W, b.W);
            return result;
        }
        ...
        public static Vector4i Clamp(Vector4i vec, Vector4i min, Vector4i max)
        {
            ...
            result.W = MathU.Clamp(vec.W, min.W, max.W);
            return result;
        }
        ...
        {
            return String.Format("({0}{4} {1}{4} {2}{4} {3})", X, Y, Z, W, MathU.ListSeparator);
        }
